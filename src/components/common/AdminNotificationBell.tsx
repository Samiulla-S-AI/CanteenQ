                        ...
                        {notifications.length === 0 ? (
                            <div className="p-8 text-center">
                                ...
                                <p className="text-sm text-gray-400 mt-1">
                                    You'll be notified about feedback and updates
                                </p>
                            </div>
                        ) : (
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            <div className="flex-1 min-w-0">
                                                ...
                                                {(notification as any).feedbackData && (
                                                    <div className="mt-2 p-2 bg-gray-100 rounded-lg">
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <span className="text-yellow-500">
                                                                {'★'.repeat((notification as any).feedbackData.rating)}
                                                                {'☆'.repeat(5 - (notification as any).feedbackData.rating)}
                                                            </span>
                                                            <span className="text-xs text-gray-600">
                                                                {(notification as any).feedbackData.rating}/5
                                                            </span>
                                                        </div>
                                                        {(notification as any).feedbackData.comment && (
